...
const projects = [
  ...
  },
  {
    name: "ChargeTrip",
    description:
      "ChargeTrip makes switching to electric mobility easy and cost-effective for both private drivers and fleets. Chargetrip is the world’s leading range prediction and EV routing platform. ChargeTrip is a website that provides an electric vehicle (EV) route planning and optimization platform for businesses and individuals. This site is developed using Vue.js and I worked as front-end developer.",
    tags: [
      {
        name: "Vue.js",
        color: "blue-text-gradient",
    ...
    image: chargetrip,
    source_code_link: "",
    netlify_link: "https://chargetrip.com/",
  },
  {
    name: "Meal Prepify",
    description:
    ...
    image: mealprepify,
    source_code_link: "",
    netlify_link: "https://mealprepify.com/",
  },
];
